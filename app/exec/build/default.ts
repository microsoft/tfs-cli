...
export interface BuildArguments extends CoreArguments {
	...
	waitForActiveRequests:args.BooleanArgument;
}
...
export class BuildBase<TArguments extends BuildArguments, TResult> extends TfCommand<TArguments, TResult> {
	...
	protected setCommandArgs(): void {
		...
		this.registerCommandArgument("waitForActiveRequests", "Wait For Active Requests", "Waiting for active Agent jobs / requests", args.BooleanArgument, "false");
}
